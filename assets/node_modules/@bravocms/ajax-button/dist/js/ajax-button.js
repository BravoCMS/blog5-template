...
(function (global, factory) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        factory((global.ajaxButton = {}), global.jQuery);
    }
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        if ($(this).data('remove')) {
                            ...
                            var $parentElement = $removeElement.parent();

                            $removeElement.remove();
                            $parentElement.trigger('removed.ls');
                        }
                    ...
                    var confirmMessage = $(this).data('force-confirm');
