    ...
    var Manager = function ($) {
        ...
        var Manager = function () {
            ...
            _proto._setValue = function _setValue(ids) {
                ...
                if (ids.length) {
                    for (var i = 0; i < ids.length; i++) {
                        selectedFiles[ids[i]] = files[ids[i]];
                    }
                }
                ...
                if (!this._element) {
                    ...
                    $(this._element).trigger('change', [selectedFiles]);
    ...
    <div class="modal-content">
        ...
        <div class="modal-body js-file-manager-body">
            <div class="manager-body">
                <div class="js-file-manager-files-toggle">
                    <div class="js-file-manager-files">
                    </div>
                </div>
                <div class="col-lg-6 file-manager-all-files js-file-manager-all-files-toggle hide">
                    <div class="js-file-manager-all-files">
                    </div>
...
//<button type="button" class="btn btn-info js-file-manager-all-button">Все файлы</button>
            file: `
<div class="manager-photo-wp js-file-manager-file file-manager-file" data-file-id="%%id%%">
    ...
    <a style="background: url(%%image_thumbnail%%) no-repeat center / cover" class="img-fluid js-file-manager-file-handle"> </a>
</div>
`,
...
// </div>style="background: url(%%image_thumbnail%%) no-repeat center / cover"
            controlFile: `
<li>
    <div class="la-image-container js-file-manager-control-file file-manager-control-file" data-file-id="%%id%%">
        <img src="%%image_thumbnail%%" class="img-fluid" img-width="0" img-height="0"/>
        <a class="la-block-image-text-button edit-photo-btn" title="Редактировать изображение"><span class="material-icons ic_mode_edit"></span></a>
    </div>
</li>
`,
            messageInfo: `
...
`,
// <li>
//     <div class="la-image-container js-file-manager-all-file file-manager-all-file" data-file-id="%%id%%">
//         <img src="%%image_thumbnail%%" class="img-fluid" img-width="0" img-height="0"/>
//         <a class="la-block-image-text-button edit-photo-btn" title="Редактировать изображение"><span class="material-icons ic_mode_edit"></span></a>
//     </div>
// </li>
            allFile: `
<div class="js-file-manager-all-file file-manager-all-file manager-photo-wp" data-file-id="%%id%%">
    <a style="background: url(%%image_thumbnail%%) no-repeat center / cover" class="img-fluid"> </a>
</div>
`,
            fileUpdateModal: `
                ...
                <form action="%%action%%" method="POST">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <a class="blank-link" href="%%absolute_url%%" target="_blank">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="photo[%%id%%][href]">
                                    Ссылка для перехода
                                </label>
                                <input type="text" placeholder="Ссылка при клике на фото в режиме &quot;слайдер&quot; и &quot;галерея&quot;" autosaving-name="photo[%%id%%][href]" id="photo[%%id%%][href]" data-post="%%csrfData%%" class="form-control" value="%%href%%" />
                            </div>

                            <div class="form-group">
                                <label for="photo[%%id%%][source]">
                                    Ссылка на источник
                                </label>
                                <input type="text" placeholder="Укажите ссылку происхождения фото" id="photo[%%id%%][source]" autosaving-name="photo[%%id%%][source]" data-post="%%csrfData%%" class="form-control" value="%%source%%" />
                            </div>

                            <div class="form-group">
                                <label for="photo[%%id%%][date_taken]">
                                    Дата съемки
                                </label>
                                <input type="text" id="photo[%%id%%][date_taken]" autosaving-name="photo[%%id%%][date_taken]" data-post="%%csrfData%%" class="form-control js-file-manager-file-update-date-taken" value="%%date_taken%%" />
                            </div>
